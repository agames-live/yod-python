"""Tests for the asynchronous AsyncAmemoClient."""
...
class TestAsyncClientInitialization:
    ...
    def test_default_base_url(self):
        client = AsyncAmemoClient(api_key="sk-amemo-test")
        assert client.config.base_url == "https://api.amemo.ai"

    def test_timeout_configuration(self):
        client = AsyncAmemoClient(
            api_key="sk-amemo-test", timeout=60.0, connect_timeout=10.0
        )
...
class TestAsyncContextManager:
    ...
    async def test_async_context_manager(self):
        async with AsyncAmemoClient(api_key="sk-amemo-test") as client:
...
class TestAsyncMemoriesEndpoint:
    ...
    async def test_get_memory_history(self, sample_memory_list_response: dict):
        respx.get("https://api.amemo.ai/memories/mem_123/history").mock(
            return_value=Response(200, json=sample_memory_list_response)
        )
...
class TestAsyncErrorHandling:
    ...
    async def test_authentication_error(self):
        ...
        async with AsyncAmemoClient(api_key="bad-key") as client:
    ...
    async def test_rate_limit_with_retry_after(self):
        ...
        async with AsyncAmemoClient(api_key="sk-amemo-test", max_retries=0) as client:
